...
const routerControl = Object.freeze({
  ...
  addChatGptAccount: (label, preferred = false) =>
  ...
  removeChatGptAccount: (accountId) =>
    call("removeChatGptAccount", { accountId }),
  refreshChatGptAccount: (accountId) =>
    call("refreshChatGptAccount", { accountId }),
  loginChatGptAccount: (accountId) =>
    call("loginChatGptAccount", { accountId }),
  ...
  setModelSync: (enabled) => call("setModelSync", { enabled }),
  setChatDefaultModel: (slug) => call("setChatDefaultModel", { slug }),
  setCronDefaultModel: (slug) => call("setCronDefaultModel", { slug }),
  setChatDefaultEffort: (effort) => call("setChatDefaultEffort", { effort }),
  setCronDefaultEffort: (effort) => call("setCronDefaultEffort", { effort }),
  setNativeTakeoverModel: (slug) => call("setNativeTakeoverModel", { slug }),
  setNativeTakeoverEffort: (effort) => call("setNativeTakeoverEffort", { effort }),
  setNativeTakeoverCronEffort: (effort) => call("setNativeTakeoverCronEffort", { effort }),
  setChatGptReserveEnabled: (enabled) => call("setChatGptReserveEnabled", { enabled }),
  setChatGptReserveEffort: (effort) => call("setChatGptReserveEffort", { effort }),
  setChatGptReserveCronEffort: (effort) => call("setChatGptReserveCronEffort", { effort }),
  discoverChatGptReserve: () => call("discoverChatGptReserve", {}),
  useDiscoveredChatGptReserve: () => call("useDiscoveredChatGptReserve", {}),
